...
class ppa1FunctionTest {
	...
	public void evenTest() {
		...
		assertArrayEquals(test.splitTheTip(10, 2), testResult1,
				"10 + 1.50 tip divided by 2 people should be 5.75 per guest");
		assertArrayEquals(test.splitTheTip(12, 3), testResult2,
	...
	public void roundTest() {
		...
		assertArrayEquals(test.splitTheTip(11.48, 2), testResult1,
				"11.48 + 1.722 tip divided by 2 people should be 6.6 per guest when rounded");
		assertArrayEquals(test.splitTheTip(12.05, 3), testResult2,
	...
	public void unevenTest() {
		...
		assertArrayEquals(test.splitTheTip(13.00, 4), testResult1,
				"13.00 + 1.95 tip divided by 4 people should be 3.73 per guest with 0.03 remainder");
		assertArrayEquals(test.splitTheTip(100, 9), testResult2,
	...
	public void zeroTest() {
		...
		assertArrayEquals(test.splitTheTip(15, 0), testResult1,
				"it should return -1 so it shows that there is no guests. It prevents an error of dividing by 0");
		assertArrayEquals(test.splitTheTip(0.0, 2), testResult2,
	...
	public void nonDecimalTest() {
		...
		assertEquals(test.shortestDistance(0.0, 0.0, 1.0, 0.0), testResult1,
	...
	public void decimalTest() {
		...
		assertEquals(test.shortestDistance(3.12, 4.67, 1.5, 2.5), testResult1,
				"The distance should be 2.7080 with 4 dp of precision");
		assertEquals(test.shortestDistance(4.23, 5.14, 6.63, 66.0), testResult2,
